...
<section class="privacy-policy">
    <div class="container">
        <div class="top-text">
            <h2 class="section-title section-title--black sr-element fade-up" data-delay="150">Privacy Policy</h2>
        </div>

        <div class="privacy-policy__content sr-element fade-up" data-delay="350" data-view-factor="0.0">
            ...
            <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when
                ...
                data. Our <span>Privacy Policy</span> for himarkisland is created with the help of the Free
            ...
            <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection
                ...
                <a href="./">https://himarkisland.com/</a>
            </p>
            ...
            <h3>Usage Data</h3>
            <p>We may also collect information how the Service is accessed and used ("<span>Usage Data</span>"). This Usage Data may
            ...
            <p><span>We use cookies and similar tracking</span> technologies to track the activity on our Service
            ...
            <ul class="list-bold">
                ...
                <li>Preference Cookies. We use Preference Cookies to remember your preferences</li>
            ...
            <p>We may update our <span>Privacy Policy</span> from time to time. We will notify you of any changes by
                posting the new
            ...
            <h2>Contact Us</h2>
            <p>If you have any questions about this <span>Privacy Policy</span>, please contact us:
            </p>
            <p>+1 514-446-1416 <br>
                8:30 AM to 4:30 PM Eastern <br>
                Monday - Friday</p>
            <p>By visiting this page on our website: <a
                    href="./contact.php">https://himarkisland.com/contact</a></p>
        </div>
    </div>
</section>
<!-- Footer -->

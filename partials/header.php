<?php
    ...
    global $header_style;
    $file_name = str_replace( [ '/', '.php'], '', $_SERVER['PHP_SELF']);
...
<head>
    ...
    <!-- Stylesheet -->
    <link href="assets/css/theme.css?ver=1.1.0" rel="stylesheet">
                ...
                <div class="header flex v_center space-between">
                        ...
                        <div class="flex v_center">
                            ...
                            <div class="header__menu">
                                <div class="mobile-btn hidden-desktop flex space-between">
                                    ...
                                    <ul>
                                        <li><a href="/" class="language-switcher switcher-en active">EN</a></li>
                                        <li><a href="/fr" class="language-switcher switcher-fr">FR</a></li>
                                    </ul>

                                </div>
                                <ul class="flex">
                                    <li><a class="nav-item-homage <?php echo ($file_name == 'index') ? 'active' : ''; ?>" href="./">Home</a></li>
                                    <li><a class="nav-item-explore-islands <?php echo ($file_name == 'explore-islands' && $target != 'downloads') ? 'active' : ''; ?>" href="./explore-islands.php">Explore the Islands</a></li>
                                    <li><a class="nav-item-design-center <?php echo ($file_name == 'design-center') ? 'active' : ''; ?>" href="./design-center.php">Design Center</a></li>
                                    <li><a class="nav-item-downloads <?php echo ($file_name == 'explore-islands' && $target == 'downloads') ? 'active' : ''; ?>" href="./explore-islands.php?target=downloads#downloads" class="">Downloads</a></li>
                                    <li><a class="nav-item-custom-order <?php echo ($file_name == 'custom-order') ? 'active' : ''; ?>" href="./custom-order.php">Order form</a></li>
                                    <li><a class="nav-item-contact <?php echo ($file_name == 'contact') ? 'active' : ''; ?>" href="./contact.php">Contact</a></li>
                                </ul>
                    ...
                    <div class="header__right flex v_center hidden-mobile">
                        <div class="language-selector flex">
                            <a href="/" class="language-switcher switcher-en active">EN</a>
                            <a href="/fr" class="language-switcher switcher-fr">FR</a>
                        </div>
                        <div class="cta">

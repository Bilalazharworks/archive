            ...
            <div class="hero-content">
                <div class="hero-content__inner">
                    <div class="content-wrapper">
                        ...
                        <h1 class="h1 sr-element fade-up" data-delay="150">D’innombrables possibilités de personnalisation</h1>

                        <div class="content-box sr-element fade-up" data-delay="300">
                            <p class="copy copy--has-dot">Les clients veulent que leur design d’intérieur aille de pair avec l'image de leur entreprise — pourquoi les cabines privées devraient-elle faire exception?</p>
                            <p class="copy copy--has-dot visible-mobile">Avec Island, trois couleurs de structure sont offertes avec une finition texturée mate et anti-empreintes. Soyez exceptionnellement créatif avec les tissus intérieurs disponibles dans 24 couleurs standards.</p>
                            <p class="copy copy--has-dot visible-mobile">Et encore plus exceptionnel: une gamme illimitée d’options de personnalisation est disponible.</p>
                        </div>
    ...
    <div class="container">
        <div class="flex content-wrapper">
            <div class="content-block sr-element fade-up" data-delay="250">
                <p class="copy copy--black">Avec Island, trois couleurs de structure sont offertes avec une finition texturée mate et anti-empreintes. Soyez exceptionnellement créatif avec les tissus intérieurs disponibles dans 24 couleurs standards.</p>
            </div>

            <div class="content-block sr-element fade-up" data-delay="350">
                <p class="copy copy--black">Et encore plus exceptionnel: une gamme illimitée d’options de personnalisation est disponible.</p>
            </div>
        </div>
    </div>
</section>
...
<section id="design-center" class="design-center">
    <div class="container">
        <div class="top-text">
            <h2 class="section-title section-title--black sr-element fade-up" data-delay="150">Centre de design</h2>
        </div>
            ...
            <div class="design-cta js-customizer-options sr-element fade-up" data-delay="250">
                ...
                <div class="color-swatches">
                    <div class="standard-frame">
                        <p class="copy copy--black">Couleurs de cadre standard -</p>
                    ...
                    <div class="standard-interior">
                        <p class="copy copy--black">Couleurs standard des panneaux intérieurs -</p>
...
<section class="sustainability architect-designers" id="architect-designers">
    <div class="container">
        <div class="top-text">
            <h2 class="section-title section-title--black sr-element fade-up" data-delay="150">Architectes et Designers
            </h2>
        </div>
        <div class="row">
            <div class="col-60">
                <div class="showcase sr-element fade-up" data-delay="350">
                    <img src="../assets/images/architect.jpg" alt="architects and designers">
                </div>
            </div>
            <div class="col-40 content-box">
                <h3 class="sr-element fade-up" data-delay="250">Island est un aller simple vers des clients épatés.</h3>
                <p class="copy copy--black sr-element fade-up" data-delay="300">
                Nous savons que les designers et les architectes concrétisent leurs réalisations grâce à la liberté de création offerte par des options flexibles.
                    <br><br>
                    Notre <span class="underline-text">Private Island</span> accueille un individu, alors que notre notre Island peut en accommoder jusqu’à quatre. En fonction de votre esthétique et/ou de vos exigences techniques, notre <span class="underline-text">Island</span> peut être déployée facilement, soit en doublant sa structure ou en ajoutant des extensions, à vous de choisir.</p>
            </div>
        </div>

        <div class="row col-sm">
            <div class="col-60 content-box content-box--lg">
                <p class="copy copy--black sr-element fade-up hidden-mobile" data-delay="300" style="padding-right: 0;">Nous pouvons doubler sa structure, ajouter des rallonges, choisir des couleurs extérieures et des tissus intérieurs - vous choisissez.</p>
                <p class="copy copy--black sr-element fade-up hidden-mobile" data-delay="350" style="padding-right: 0;">Appelez votre représentant Island pour obtenir plus d’information sur les différentes configurations disponibles.</p>
                <p class="copy copy--black sr-element fade-up visible-mobile" data-delay="350" style="padding-right: 0;">Nous savons que les designers et les architectes concrétisent leurs réalisations grâce à la liberté de création offerte par des options flexibles.</p>

                <div class="showcase showcase--image-only visible-mobile sr-element fade-up" data-delay="400">
                    <img src="../assets/images/architect-2.jpg" alt="architects and designers">
                </div>

                <p class="copy copy--black sr-element fade-up visible-mobile" data-delay="300">Appelez votre représentant Island pour obtenir plus d’information sur les différentes configurations disponibles.</p>

                <div class="btn-wrap sr-element fade-up" data-delay="300" style="margin-top: 40px;">
                    <a href="./contact.php" class="btn--cta btn--cta--orange">Contactez-nous <svg width="18" height="18"

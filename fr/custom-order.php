...
<section class="custom-order">
    ...
    <form id="custom-order-form" method="POST" action="<?php echo BASE_URL; ?>inc/order-mail.php">
        ...
        <div class="container">
            <div class="top-text">
                <h2 class="section-title section-title--black sr-element fade-up" data-delay="150">Formulaire de commande</h2>
            </div>
            ...
            <div class="order-form-wrapper">
                <div class="col-left">
                    <div class="fields-wrapper">
                        <div class="input-wrapper sr-element fade-up w-50" data-delay="200">
                            <input type="text" name="customer_name" value="" placeholder="Client *" required>
                        </div>
                        ...
                        <div class="input-wrapper sr-element fade-up w-50" data-delay="260">
                            <input type="text" name="order_date" value="" placeholder="Date de la commande *" required class="datepicker">
                        </div>

                        <div class="input-wrapper sr-element fade-up w-50" data-delay="290">
                            <input type="text" name="ship_date" value="" placeholder="Date d’expédition" required class="datepicker">
                        </div>

                        <div class="input-wrapper sr-element fade-up" data-delay="320">
                            <input type="text" name="delivery_address" value="" placeholder="Adresse de livraison *" required>
                        </div>

                        <div class="input-wrapper sr-element fade-up" data-delay="350">
                            <input type="text" name="dealer" value="" placeholder="Concessionnaire">
                        </div>

                        <div class="input-wrapper sr-element fade-up w-50" data-delay="380">
                            <input type="text" name="contact_person" value="" placeholder="Personne-ressource *" required>
                        </div>

                        <div class="input-wrapper sr-element fade-up w-50" data-delay="410">
                            <input type="text" name="sales_person" value="" placeholder="Personne de vente *" required>
                        </div>

                        <div class="input-wrapper sr-element fade-up w-50" data-delay="440">
                            <input type="tel" name="phone_number" value="" placeholder="Numéro de téléphone *" required>
                        </div>

                        <div class="input-wrapper sr-element fade-up w-50" data-delay="470">
                            <input type="email" name="email" value="" placeholder="Courriel *" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-right">
                    ...
                    <p class="sr-element fade-up" data-delay="450">Veuillez remplir le formulaire pour <span class="text-orange">chaque</span> cabine Island commandée:</p>

                    <ul>
                        <li class="sr-element fade-up" data-delay="500">Himark Innovative Products confirmera le <span>prix et la livraison</span> dans les 24 à 48 heures.</li>
                        <li class="sr-element fade-up" data-delay="550"><span>Le délai de livraison standard F.O.B.</span> est de 3 à 4 semaines après réception du dépôt par Himark Innovative Products.</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="characteristics">
            <div class="container">
                <h3 class="title-heading sr-element fade-up" data-delay="150">Sélectionner les caractéristiques:</h3>
                    ...
                    <div class="accordion custom-order__accordions">
                        ...
                        <div class="col-50 sr-element fade-up" data-delay="350">
                            ...
                            <div class="accordion-item" data-stack="4">
                                <div class="accordion-title">
                                    <h3>Porte (côté de la poignée) / Code</h3>
                                </div>
                                <div class="accordion-content">
                                    <div class="door-sides-wrapper">
                                        <div class="block">
                                            <div class="block-title">Poignée gauche de la porte</div>
                                        ...
                                        <div class="block">
                                            <div class="block-title text-right">Poignée droite de la porte</div>
                                    ...
                                    <ul>
                                        <li class="custom-control custom-radio">
                                            ...
                                            <label for="product_side-1">1 porte, gaucher<span class="ml-auto">L1</span></label>
                                        </li>

                                        <li class="custom-control custom-radio">
                                            <input type="radio" name="product_side" id="product_side-2" value="L2">
                                            <label for="product_side-2">2 portes, gaucher <span>*</span><span class="ml-auto">L2</span></label>
                                        </li>

                                        <li class="custom-control custom-radio">
                                            <input type="radio" name="product_side" id="product_side-3" value="R1">
                                            <label for="product_side-3">1 porte, droitier <span>*</span><span class="ml-auto">R1</span></label>
                                        </li>

                                        <li class="custom-control custom-radio">
                                            <input type="radio" name="product_side" id="product_side-4" value="R2">
                                            <label for="product_side-4">2 portes, droitier <span>*</span><span class="ml-auto">R2</span></label>
                                        </li>

                                        <li class="custom-control custom-radio">
                                            <input type="radio" name="product_side" id="product_side-5" value="LR">
                                            <label for="product_side-5">2 portes, 1 gaucher + 1 droitier <span>*</span><span class="ml-auto">LR</span></label>
                                        </li>
                                    </ul>

                                    <div class="note"><span>*</span> seulement disponible pour des capacités de 6 ou plus</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-100 sr-element fade-up" data-delay="450">
                            <div class="accordion-item" data-stack="5">
                                <div class="accordion-title">
                                    <h3>Tissu du panneau latéral (cochez une case)</h3>
                                    <span>(Remarque : Le plafond standard est Maharam Grey)</span>
                                </div>
            ...
            <div class="container">
                <div class="fields-wrapper">
                    <div class="input-wrapper w-70 sr-element fade-up" data-delay="150">
                        <textarea name="comments" id="" placeholder="Commentaires" rows="1"></textarea>
                        ...
                        <div class="custom-control custom-checkbox sr-element fade-up" data-delay="150">
                            ...
                            <label for="order_copy">Je veux recevoir une copie à mon adresse électronique</label>
                        </div>
                    </div>
                    ...
                    <div class="input-wrapper w-30 sr-element fade-up" data-delay="300">
                        ...
                        <button type="submit" class="btn submit-btn" data-label-normal="Envoyer" data-label-processing="Envoi...">Envoyer</button>
                    </div>
                </div>
...
<div id="submission-received" class="alert-popup mfp-with-anim mfp-hide">
    <div class="popup-inner text-center">
        ...
        <h3 class="popup-title">MERCI</h3>

        <p>Votre demande a été reçue. Nous vous contacterons bientôt !</p>

        <div class="btn-wrap">
            <a href="./custom-order.php" class="btn">RETOUR AU SITE</a>
        </div>
    </div>
</div>
